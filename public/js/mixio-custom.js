...
$(function() {
  ...
  //if(bgndKenburns.length){
    //bgndKenburns.vegas({
      ...
      //slides: [
        //{ src: "../img/backgrounds/bg-main.webp" },
        //{ src: "../img/backgrounds/bg-main-7.webp" },
        //{ src: "../img/backgrounds/bg-main-9.webp" }
      //],
  ...
  if(bgndKenburns1.length){
    bgndKenburns1.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1920x1280-bg-main-1.webp" },
        { src: "img/backgrounds/1920x1280-bg-main-2.webp" },
        { src: "img/backgrounds/1920x1280-bg-main-3.webp" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  }
  ...
  if(bgndKenburns2.length){
    bgndKenburns2.vegas({
      ...
      transitionDuration: 2000,
      slides: [
        { src: "img/backgrounds/1920x1280-bg-main-4.webp" },
        { src: "img/backgrounds/1920x1280-bg-main-5.webp" },
        { src: "img/backgrounds/1920x1280-bg-main-6.webp" }
      ],
      animation: [ 'kenburnsUp', 'kenburnsDown', 'kenburnsLeft', 'kenburnsRight' ]
    });
  }
  ...
  $('#countdown-large').countdown({until: $.countdown.UTCDate(+10, 2025, 10, 27), format: 'DHMS'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
