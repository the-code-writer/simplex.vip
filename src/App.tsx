            ...
            <div className="row g-0 fullheight">
              ...
              <div className="col-12 fullheight home__intro intro-bg-5">
                ...
                <div className="intro__headline">
                  <Fade delay={500}>
                    <h1 className="light-text hero-text">
                      <Fade delay={500}>
                        <span>
                      ...
                      <Fade delay={500}>
                        <span>Redefine Your Industry.</span>
                      </Fade>
                    </h1>
                  </Fade>
                ...
                <div className="col-12 col-xl-12 inner__info">
                  <div className="content-block auto-height form-block">
                    ...
                    <div className="section-title">
                      ...
                      <Fade delay={500}>
                        <h2 className="cta-text">Seize the Moment</h2>
                      </Fade>
                      <br />
                      <Fade delay={500}>
              ...
              <div className="form-container">
                ...
                <div className="reply-group subscription-ok">
                  ...
                  <span className="reply-group__text">
                    Thanks for subscribing. We will send you a notification
                    about the launch of our brand new website.
                  </span>
                </div>
